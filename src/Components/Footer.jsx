      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
          <a
            ...
            className="transition text-sm flex gap-2 items-center hover:text-blue-400"
          >
          ...
          <a
            ...
            className="transition text-sm flex gap-2 items-center hover:text-white"
          >
          ...
          <a
            ...
            target="_blank"
            className="transition text-sm flex gap-2 items-center hover:text-sky-400"
          >
